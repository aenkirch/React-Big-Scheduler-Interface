...
import { LOAD_AGENDA_DATA, ALL_FORMATIONS_LOADED, ALL_GROUPES_LOADED } from "../constants/index";
    ...
    return function(dispatch){
        return axios.post('/api/getModule', {
            ...
            return axios.post('/api/getCreneaux', {
                ...
                dispatch({ type: LOAD_AGENDA_DATA, payload: {resources: resResources.data, events: resEvents.data} })
            })
        })
    }
};
